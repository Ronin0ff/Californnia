...
const SkuManagement: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    const skuData: Partial<Sku> = {
      ...
      commission_pct: parseFloat(form.commission_pct) || mp?.base_commission_pct || 0,
      logistics_cost: parseFloat(form.logistics_cost) || mp?.logistics_base_cost || 0,
      return_rate_pct: parseFloat(form.return_rate_pct) || mp?.return_cost_pct || 0,
